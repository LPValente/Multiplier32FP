...
O presente trabalho visa implementar um multiplicador em ponto flutuante no padrão IEEE 754 de 32 bits em SystemVerilog e executar as sínteses física e lógica para extrair informações de área, potência e timing.
...
A organização das pastas foi definida seguindo o padrão determinado, adicionando pequenas mudanças por questão de organização.
...
- Xcelium (xrun): utilizado para simulação do RTL e dos netlists gerados;
- Genus: utilizado para síntese lógica;
- Innovus: utilizado para síntese física.
